        ...
        <script>
            ...
            jQuery(function($) {
                ...
                $('#<?php echo $assetpv[1] ?>durn').keyup(function() {
                    var <?php echo $assetpv[1] ?>u = parseFloat($(this).val())+parseFloat($('#<?php echo $assetpv[1] ?>delay').val())+(parseFloat($(this).val()) * parseFloat($('#<?php echo $assetpv[1] ?>repeat').val()))+(parseFloat($('#<?php echo $assetpv[1] ?>repeat_delay').val())*parseFloat($('#<?php echo $assetpv[1] ?>repeat').val()));
                ...
                $('#<?php echo $assetpv[1] ?>delay').keyup(function() {
                    var <?php echo $assetpv[1] ?>v = parseFloat($(this).val())+parseFloat($('#<?php echo $assetpv[1] ?>durn').val())+(parseFloat($('#<?php echo $assetpv[1] ?>durn').val()) * parseFloat($('#<?php echo $assetpv[1] ?>repeat').val()))+(parseFloat($('#<?php echo $assetpv[1] ?>repeat_delay').val())*parseFloat($('#<?php echo $assetpv[1] ?>repeat').val()));
                ...
                $('#<?php echo $assetpv[1] ?>repeat').keyup(function() {
                    var <?php echo $assetpv[1] ?>x = parseFloat($('#<?php echo $assetpv[1] ?>durn').val()) + parseFloat($('#<?php echo $assetpv[1] ?>delay').val()) + (parseFloat($('#<?php echo $assetpv[1] ?>durn').val()) * parseFloat($(this).val())) + (parseFloat($('#<?php echo $assetpv[1] ?>repeat_delay').val())*parseFloat($('#<?php echo $assetpv[1] ?>repeat').val()));
