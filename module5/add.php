...
$url = $_SERVER['REQUEST_URI'];
  ...
  for($i=0;$i<6;$i++){
    $autofcat.= substr($characters,rand(0,$charCount-1),1);
  }
  
  $sqlfcat = "SELECT DISTINCT fcat FROM $client";
  $resultfcat = mysqli_query($connectDB,$sqlfcat);
              ...
              echo '<tr>';
                        ...
                        {                   
                          ...
                          elseif($name[$i]=="Select Assets"){                            
                            ...
                            AND TABLE_SCHEMA = 'publishe_selfserve'";                                                    
                            $replaced = $connectDB->query($sql);
...
$finallink=${"msi2".$js}.$enter2;
  ...
  $result=mysqli_query($connectDB,$sqlin);
  if($result){
