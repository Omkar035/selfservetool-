...
<script>
  ...
  let assetManager = HC.AssetManager(document.body)
   ...
   {
  const object = { "paths":["apvideo/jublieexp/1290x250/"] };
  ...
  var keyss=test['data'][0]['key']
    ...
    assetManager.showFolders([{path:'apvideo/jublieexp/1290x250/',key:keyss}])

await assetManager.getFiles({path:'apvideo/jublieexp/1290x250/',key:keyss})
