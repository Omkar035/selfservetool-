...
//                  while ($row = mysqli_fetch_array($campaign_title)) {
//     print_r ($row['campaign_title']);
// }


$recom = "SELECT * FROM `campaign_info`";
     $result3=mysqli_query($connectDB,$recom);
         
     $test = array();
     while ($row2 = $result3->fetch_assoc()){
         array_push($test,$row2['campaign_title']);}

  
  if (in_array($campaign_title, $test))
  {
    echo "<span style='color:red;font-size:15px;position:absolute;top:208px;left:652px;z-index:99'>title is already exist</span>";;
  }else{
      echo('galat hai');
  }
...
<div class="sidebar" style="font-family:bold;position:fixed;top: 0;left: 0;background-color: #0b4da1;width:300px;padding-top: 5.5em;height:100%;cursor:pointer;z-index:5">
    <div style="position: absolute;width: 300px;height: 70px;top: 345px;"></div>
  ...
  <li class="a" ><img class="icon" style="width: 16%;" src="https://s.hcurvecdn.com/atest/mahesh/cam_info/assets/campicon.png">&nbsp;&nbsp;&nbsp;Campaign Info</li>
  ...
  <li onclick="opact();" class="a bot" style="cursor:pointer;bottom: 10px;margin-top: 25%;"><img class="icon"src="https://s.hcurvecdn.com/atest/pooja/updateanimation/icons/Setting.png">&nbsp;&nbsp;&nbsp;SETTING</li>
</div>
...
<img style="height: 15px;position: absolute;top: 3px;left: 3px;" class="probardot" src="https://hcurvecdn.com/atest/pooja/updateanimation/progressbarselection.png"></div>
 ...
 <div style="position:fixed;right:4em;white-space: nowrap;font-size: 1;5em;font-family: bold;z-index:99">
    <div style="display: inline-block;margin-top:10%;margin-right: 5%;font-family: 'monB';"><?php echo $_SESSION['username'] ?></div>
    <a href="logout.php" style="color:white;text-decoration:none"><img style="position:fixed;width:3%" src="https://s.hcurvecdn.com/atest/pooja/updateanimation/UserProfile-Icon.png" /></a>
   </div>
   ...
   <div class="master">
      ...
      <div class="container">
        ...
        console.log("updated creative page")
...
function specialcharecter() {
    ...
    <script>
        ...
        var titvalue = document.getElementById("input3").value;
        if(testbm == "updated" ){
            if(titvalue.includes("replica")){
          document.getElementById("adtag_type").enabled = true;
            document.getElementById("track").style.display = "block";
           }else{
