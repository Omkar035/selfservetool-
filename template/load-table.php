...
if(mysqli_num_rows($result) > 0 ){
  ...
  <button onclick="refresh" class="btn btn-primary">Back</button><br>
  <table id="table" style="margin-top: 40px">
              <tr>
                <th style="width:200px;padding: 15px;">Template name</th>
                <th style="width:400px;padding: 15px;">Default AD</th>
                <th style="padding: 15px;">Dimension</th>
                <th style="padding: 15px;">Submit</th>
              </tr>';
   ...
   <button style='float:right' id='popup' class='btn btn-success' onclick='clickchange()' type='submit' name='submit'>Submit</button></td>
                </tr>";
  }    
   $output .= "</table>
   </form>";
