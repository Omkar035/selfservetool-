...
if(mysqli_num_rows($result) > 0 ){
  ...
  <button onclick="refresh" class="btn btn-primary">Back</button>
  <table style="margin:30px">
   ...
   $output .= "</table>
   <button style='float:right' id='popup' class='btn btn-success' onclick='clickchange()' type='submit' name='submit'>Submit</button>
   </form>";
