...
<body>
  ...
  <?php
    ...
    <?php } ?>
        ...
        <div id="dims_total" style="width:400px;margin:0 auto;text-align:center;font-size:1.1rem;font-weight:bold"></div>
...
document.getElementById("updt_creat").addEventListener("click",()=>{
    ...
    var multifeed_url = "https://publisherplex.io/selfserve/feed/multifeed.php?id=<?php echo $id ?>";
    ...
    $(document).on("click","#sv_nxt",function(e){
        ...
        <?php 
            ...
            $time_curnt = date('Y-m-d H:i:s');
        ?>        
        },1000)
    
    console.log("<?php echo $time_curnt; ?>")
    ...
    document.getElementById("yes").addEventListener("click",()=>{
        if("<?php echo $_SESSION['creative_type'] ?>" == "replica"){
            var dim_change = "<?php echo $fcat ?>";
            path = path.split('/')[0]+"/"+dim_change+"/"+path.split('/')[2];
