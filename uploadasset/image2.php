<?php
    ...
    //     header("location:./test_cre.php?id=$id");
    // }
    // if(isset($_POST['done'])){
    //     // $_SESSION['ast_val'] = 1;
    ...
    <body>
        <div id="ast_bx">
            ...
            <div>
                ...
                <button style="margin:10px 0" id="add_rm">Add/Remove Assets</button>
            </div>
            <div id="err_bx"></div>
        ...
        <span>Check <a target="_blank" href="https://drive.google.com/drive/folders/18GSWWOafnKQ0El050R7Z3ROUyMSVmEMj?usp=sharing">Demo assets</a> for asset stucture</span>
<script>
...
async function assest(){
    ...
    window.location = "./creative1.php?id=<?php echo $id; ?>";
}
