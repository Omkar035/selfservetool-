<?php 
    ...
    if(mysqli_num_rows($result)>0){
      ...
      $('select').selectize({
        ...
        $output.="</select><button id='btn01' onclick='testmb();' name='submit' style='background:#228B22;border:none;width:100px;height:40px;border-radius:5px;'>Submit</button> <button onclick='window.location.reload()' style='background:#0096FF;border:none;width:100px;height:40px;margin-left:20px;border-radius:5px;'>Back</button> </div> </form>";
